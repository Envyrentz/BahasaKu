...
@section('content')
    <div class="border-s-4 border-[#395670] text-3xl font-bold text-[#395670] px-3">Kelola Pengguna</div>
    ...
    <div class="w-full mb-5">
        <div class="flex justify-end my-5">
            <a href="{{ route('pengguna.create') }}" class="border-2 border-[#555050] p-2 rounded flex gap-2">

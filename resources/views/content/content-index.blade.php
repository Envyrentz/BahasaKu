...
@section('content')
    <div class="border-s-4 border-[#395670] text-3xl font-bold text-[#395670] px-3">Kelola Materi</div>
    ...
    <div class="w-full">
        <div class="flex justify-end my-5">
            <a href="{{ route('materi.create') }}" class="border-2 border-[#555050] p-2 rounded flex gap-2">
            ...
            <table id="dataTable">
                ...
                <tbody>
                    ...
                    <tr class="">
                        ...
                        <td class="font-bold">{{ $data->code }}</td>
                        <td>{{ $data->title }}</td>
                        <td>{{ $data->preview }}</td>
                        <td>
                            <img src="{{ asset('storage/materi/thumbnail/' . $data->thumbnail_path) }}" class="max-w-[10rem] rounded-xl">
                        </td>
                        <td>{{ $data->video_link }}</td>
                        <td class="flex gap-4 items-center min-h-[10rem]">
                            <a href="{{ route('materi.show', $data->id) }}">
                                <svg class="text-[#395670]" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24"><path fill="currentColor" d="M20 3H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2m-9 14H5v-2h6zm8-4H5v-2h14zm0-4H5V7h14z"/></svg>
                            </a>
                            <a href="{{ route('materi.edit', $data->id) }}">
                                <svg class="text-[#FFB84C]" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M7 7H6a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2-2v-1"/><path d="M20.385 6.585a2.1 2.1 0 0 0-2.97-2.97L9 12v3h3zM16 5l3 3"/></g></svg>
                            </a>
                            <a href="{{ route('materi.delete', $data->id) }}" onclick="return confirm('Apakah anda yakin?')">
